...
from .routes import health, journals, auth as auth_routes, insights, exports, chat, datacloud, seed
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://127.0.0.1:3000", "http://localhost:3001", "http://127.0.0.1:3001","https://hackathon-project-web.vercel.app"],
